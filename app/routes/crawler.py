...
@router.get("/results/{result_id}", response_model=CrawlResultResponse)
...
@router.post("/results/{result_id}/feedback", response_model=CrawlResultResponse)
...
@router.get("/results/ready", response_model=List[CrawlResultResponse])
...
@router.post("/results/{result_id}/mark-posted", response_model=CrawlResultResponse)
...
@router.post("/search", response_model=List[CrawlerSearchResult])
...
@router.get("/train/shards", response_model=CrawlerTrainIndex)
async def list_train_shards():
    return crawler_manager._train_index


@router.get("/train/shards/{name}")
